...
class Api {
  ...
  static const String baseurl = 'http://192.168.1.146:802/';
  ...
  Future<http.Response> putUrl({String url, dynamic body}) async {
    return await http.put(Api.url + url,
        body: jsonEncode(body), headers: {'content-type': 'application/json'});
  }

  Future<http.Response> deleteUrl(String url) async {
    return await http
        .delete(Api.url + url, headers: {'content-type': 'application/json'});
  }
